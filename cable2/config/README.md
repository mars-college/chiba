...
### Media (`cable2/config/media/*.toml`)
...
### Playlists (`cable2/config/playlists/*.toml`)
...
### Blocks (`cable2/config/blocks/*.toml`)
...
### Channels (`cable2/config/channels/*.toml`)
...
### Profiles (`cable2/config/profiles/*.toml`)

Profiles map to **kiosk launch state** (query params).

See `cable2/config/profiles/README.md`.
